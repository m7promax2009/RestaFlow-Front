...
export default function KitchenColumn({
  ...
  return (
    <div className="flex w-[85vw] shrink-0 flex-col rounded-3xl bg-white/90 p-4 sm:p-5 border border-slate-200/90 shadow-[0_12px_35px_rgba(0,0,0,0.04)] backdrop-blur-md dark:bg-[#1E293B]/90 dark:border-slate-800/90 sm:w-full sm:min-w-0 transition-all">
      <div className="mb-4 flex items-center justify-between gap-2 px-1 border-b border-slate-100 dark:border-slate-800 pb-3">
        <div className="flex items-center gap-2.5">
          <div className="flex size-7 items-center justify-center rounded-xl bg-slate-900/5 dark:bg-white/5">
        ...
        <span className={`shrink-0 rounded-full border px-3 py-1 font-mono text-xs font-bold shadow-xs ${config.badgeTone}`}>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200/80 py-12 text-center dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/40">
